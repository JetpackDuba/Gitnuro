...
sealed interface Screen : NavKey {
    ...
    data object SignOffData : Screen // TODO Impl missing
}
...
class App {
    ...
    @Inject
    lateinit var gpgSigner: com.jetpackduba.gitnuro.domain.git.signers.AppGpgSigner

    @Inject
    lateinit var sshSigner: com.jetpackduba.gitnuro.domain.git.signers.SshSigner
    ...
    fun start(args: Array<String>) {
        ...
        application {
            ...
            val dateTimeFormat = DateTimeFormat(true, null, true, true)//by appSettingsRepository.dateTimeFormatFlow.collectAsState()
