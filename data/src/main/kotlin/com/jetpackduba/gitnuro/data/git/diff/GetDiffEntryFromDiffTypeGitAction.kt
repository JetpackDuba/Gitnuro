...
interface IGetDiffEntryFromDiffTypeGitAction {
...
) : IGetDiffEntryFromDiffTypeGitAction {
    override suspend operator fun invoke(git: Git, diffType: DiffType): DiffEntry {
