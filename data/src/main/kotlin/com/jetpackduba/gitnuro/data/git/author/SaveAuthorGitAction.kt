...
class SaveAuthorGitAction @Inject constructor() : ISaveAuthorGitAction {
    override suspend operator fun invoke(git: Git, newAuthorInfo: AuthorInfo) = withContext(Dispatchers.IO) {
