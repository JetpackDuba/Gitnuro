...
class GenerateSplitHunkFromDiffResultGitAction @Inject constructor() : IGenerateSplitHunkFromDiffResultGitAction {
    override operator fun invoke(diffFormat: DiffResult.Text): List<SplitHunk> {
