...
class ResumeRebaseInteractiveGitAction @Inject constructor() : IResumeRebaseInteractiveGitAction {
    override suspend operator fun invoke(git: Git, interactiveHandler: RebaseCommand.InteractiveHandler) =
